...
public final class EmployeeServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Employee.EmployeeRequest,
      Employee.EmployeeResponse> getGetEmployeeDataMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "getEmployeeData",
  ...
  public static io.grpc.MethodDescriptor<Employee.EmployeeRequest,
      Employee.EmployeeResponse> getGetEmployeeDataMethod() {
    io.grpc.MethodDescriptor<Employee.EmployeeRequest, Employee.EmployeeResponse> getGetEmployeeDataMethod;
    if ((getGetEmployeeDataMethod = EmployeeServiceGrpc.getGetEmployeeDataMethod) == null) {
      synchronized (EmployeeServiceGrpc.class) {
        if ((getGetEmployeeDataMethod = EmployeeServiceGrpc.getGetEmployeeDataMethod) == null) {
          EmployeeServiceGrpc.getGetEmployeeDataMethod = getGetEmployeeDataMethod =
              io.grpc.MethodDescriptor.<Employee.EmployeeRequest, Employee.EmployeeResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "getEmployeeData"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Employee.EmployeeRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  Employee.EmployeeResponse.getDefaultInstance()))
              .setSchemaDescriptor(new EmployeeServiceMethodDescriptorSupplier("getEmployeeData"))
              .build();
        }
      }
    }
    return getGetEmployeeDataMethod;
  }
  ...
  public static abstract class EmployeeServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getEmployeeData(Employee.EmployeeRequest request,
        io.grpc.stub.StreamObserver<Employee.EmployeeResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getGetEmployeeDataMethod(), responseObserver);
    }

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            getGetEmployeeDataMethod(),
            asyncUnaryCall(
              new MethodHandlers<
                Employee.EmployeeRequest,
                Employee.EmployeeResponse>(
                  this, METHODID_GET_EMPLOYEE_DATA)))
          .build();
    }
  }
  ...
  public static final class EmployeeServiceStub extends io.grpc.stub.AbstractAsyncStub<EmployeeServiceStub> {
    ...
    public void getEmployeeData(Employee.EmployeeRequest request,
        io.grpc.stub.StreamObserver<Employee.EmployeeResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(getGetEmployeeDataMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class EmployeeServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<EmployeeServiceBlockingStub> {
    ...
    /**
     */
    public Employee.EmployeeResponse getEmployeeData(Employee.EmployeeRequest request) {
      return blockingUnaryCall(
          getChannel(), getGetEmployeeDataMethod(), getCallOptions(), request);
    }
  }
  ...
  public static final class EmployeeServiceFutureStub extends io.grpc.stub.AbstractFutureStub<EmployeeServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Employee.EmployeeResponse> getEmployeeData(
        Employee.EmployeeRequest request) {
      return futureUnaryCall(
          getChannel().newCall(getGetEmployeeDataMethod(), getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_EMPLOYEE_DATA = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_EMPLOYEE_DATA:
          serviceImpl.getEmployeeData((Employee.EmployeeRequest) request,
              (io.grpc.stub.StreamObserver<Employee.EmployeeResponse>) responseObserver);
          break;
        default:
      ...
      synchronized (EmployeeServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getGetEmployeeDataMethod())
              .build();
        }
      }
    }
